...
Were there trading of favours? 
Why did the prime minister welcome, in person, the pandas at the airport? 
Will the two pandas be the last straw that will brake Belgium apart? 
Many of these questions were brought back to memory with a lot of amusement during the booksprint. 

The choice of a panda as a main character was never thought in regards of these events. 
The majority of the participants had no knowledge of these facts (there is only 4 belgians in the team).
It's only when the question of naming the game was raised that these belgian stories were brought into light for the pleasure of the whole crew.  
The pun on "Peril in Daïza" represents well the theme of the game (a panda must save its community) and also points in a funny way to the geographical context where this project was created (Brussels).
...
Licenses
--------
Except if stated otherwise, the whole game (code and assets) is released under the GNU GPL v2.
